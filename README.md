...
This version has been modified by Diamond Age Solutions Ltd. [http://diamondage.co.nz] to include
functional support for the MAX6675 thermocouple, amongst other tweaks for their machines. It is
based on Repetier v091 [http://www.repetier.com/firmware/v091].

## Installation

Download as per standard Github instructions for your machine. Unless you are modifying the code,
downloading the Github project as a ZIP and unzipping it should provide you with enough to get going.

User the Arduino [http://arduino.cc] IDE to upload the code to your Reprap/Printer. The exact
details will depend on your hardware but a standard Diamond Age printer needs the IDE to be
configured for an Arduino Mega 2560. Open the "Repetier.ino" file in the IDE and follow the
instructions on the Arduino site for operating the IDE on your computer.

## Version 0.91 Initial DA Modifications

* Added bit-banging SPI interface for MAX6675 and introduced the correct delays in the temperature
  reading routines to allow the MAX6675 to correctly read the temperature.
* Optimised the general configuration for a standard Diamond Age "Mako" printer.
* Rearranged the menus for more ergonomic operation.

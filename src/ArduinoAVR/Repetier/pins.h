...
// Only effective if driving MAX6675 in bit-banging mode.
#define MISO_BITBANG_PIN  11
#define SCK_BITBANG_PIN   5
// Uncomment to use this pin for bit-banging the MAX6675
#define SS_BITBANG_PIN    6

#ifdef SS_BITBANG_PIN
#define MAX6675_SS       SS_BITBANG_PIN
#else

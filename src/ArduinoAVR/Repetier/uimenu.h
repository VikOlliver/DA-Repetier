...
#endif
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY ,&ui_menu_home_all BABY_ENTRY,&ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
